...
namespace ET
{
    ...
    public partial class BuildingConfigCategory : Singleton<BuildingConfigCategory>, IMerge
    {
        ...
        public Dictionary<int, BuildingConfig> GetAll()
        {
            return this.dict;
        }

        public BuildingConfig GetOne()
        {
	...
	public partial class BuildingConfig: ProtoObject, IConfig
	{
		...
		/// <summary>建筑类型 1仓库 2伐木场 3采石场 4农场 5村民小屋建筑类型 1仓库 2伐木场 3采石场 4农场 5村民小屋</summary>
		public int BuildingType { get; set; }
		/// <summary>名字</summary>
		public string Name { get; set; }
		/// <summary>大工人数量(0=不需要工人)</summary>
